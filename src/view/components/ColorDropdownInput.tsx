...
import { Dropdown as DropdownMenu } from "./DropdownMenu";
    ...
    <div className="w-full">
      <DropdownMenu.Root>
        <DropdownMenu.Trigger asChild>
          <button
            className={cn(
              "w-full bg-white rounded-lg border  border-gray-500 px-3 h-[52px] text-gray-700 placeholder-shown:pt-0 focus:border-gray-800 transition-all outline-none text-left relative",
